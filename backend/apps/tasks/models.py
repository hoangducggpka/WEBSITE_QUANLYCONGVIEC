...
#     name = models.CharField(max_length=225, unique=False)  # unique trong project (Meta)
...
#     assigned_to = models.ForeignKey(#userproject_uuid
#         UserProject,
#         on_delete=models.SET_NULL,
#         null=True,
#         blank=True,
...
#     estimation_time = models.PositiveIntegerField(null=True, blank=True)  # phút
